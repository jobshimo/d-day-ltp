...
describe('HomeComponent', () => {
  ...
  it('renders hero section with title', () => {
    ...
    const h1 = fixture.nativeElement.querySelector('.home-hero__title');
    expect(h1).not.toBeNull();
    expect(h1.textContent.trim()).toContain('D-Day en Omaha Beach');
  });

  it('renders hero cover image', () => {
    const fixture = TestBed.createComponent(HomeComponent);
    fixture.detectChanges();
    const img = fixture.nativeElement.querySelector('.home-hero__image');
  ...
  it('hub card for Curso links to /modules', () => {
    const fixture = TestBed.createComponent(HomeComponent);
    fixture.detectChanges();
    const links = Array.from(fixture.nativeElement.querySelectorAll('.hub-card')) as HTMLAnchorElement[];
    const cursoCard = links.find((el) => el.textContent?.includes('Curso'));
    expect(cursoCard).toBeDefined();
    // routerLink resolves href in RouterTestingModule
  ...
  it('hub nav has accessible aria-label', () => {
    const fixture = TestBed.createComponent(HomeComponent);
    fixture.detectChanges();
    const nav = fixture.nativeElement.querySelector('.home-hub');
